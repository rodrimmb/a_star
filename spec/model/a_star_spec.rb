...
describe AStar do
	...
	it 'first node is de goal node' do
		state = create_state(true,"A", [], false)
	...
	it 'tree with 3 levels and one node goal' do
		...
		state_child1_2_2 = create_state(false, 122, [], false)
		state_goal = create_state(true, 3, [], false)
		goal = Node.new(state_goal)

		state_child1_2 = create_state(false, 12, [state_child1_2_1, state_child1_2_2], true)
		state_child1_1 = create_state(false, 11, [state_child1_1_1, state_goal], true)
		child1_1 = Node.new(state_child1_1)

		state_initial = create_state(false, 4, [state_child1_1, state_child1_2], true)
		initial = Node.new(state_initial)

		expected_path = [initial, child1_1, goal]
