...
function addNodesToTableSolution(path){
	...
	path.open.forEach(function(open){
		var textOpen = createNodeForTable(open.name, open.cost, open.path_cost, open.deleted);
		var textOpenParent = createFatherOf(open.father);
	...
	path.successors.forEach(function(successor){
		var textSuccessor = createNodeForTable(successor.name, successor.cost, successor.path_cost, successor.deleted);
	...
	path.closed.forEach(function(closed){
		var textClosed = createNodeForTable(closed.name, closed.cost, closed.path_cost, closed.deleted);
