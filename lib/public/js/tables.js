...
function showSolution(){
	...
	var elementSolution = obtainElementsById("path-solution");
	var elementTableSolution = obtainElementsById("table-nodes-solution");
	...
	elementTableSolution.setAttribute("class", "hide-element");
}
...
function showAllSteps(){
	...
	elementSolution.removeAttribute("class");
	elementTableSolution.removeAttribute("class");
}
